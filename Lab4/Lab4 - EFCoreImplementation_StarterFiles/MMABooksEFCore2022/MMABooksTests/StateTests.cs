...
namespace MMABooksTests
{
    ...
    public class StateTests
    {
        ...
        public void Setup()
        {
            ...
            dbContext.Database.ExecuteSqlRaw("call usp_testingResetData()");    //  switch procedure
        }
        ...
        {
            s = dbContext.States.Find("OR");
            s.StateName = "New Oregon";
            
            dbContext.States.Update(s);
            dbContext.SaveChanges();
            
            s = dbContext.States.Find("OR");
            Assert.AreEqual("New Oregon", s.StateName);
        }
